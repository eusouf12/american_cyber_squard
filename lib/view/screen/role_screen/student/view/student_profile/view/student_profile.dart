...
class StudentProfile extends StatelessWidget {
      ...
      body: Stack(
        children: [
          Positioned(
            ...
            right: -40,
            child: _GlowCircle(
                size: 220, color: AppColors.primary.withValues(alpha: 0.18)),
          ),
          Positioned(
            top: 120,
            left: -60,
            child: _GlowCircle(
                size: 160, color: AppColors.primary2.withValues(alpha: 0.10)),
          ),
          Positioned(
            top: 260,
            right: 20,
            child: _GlowCircle(
                size: 80, color: AppColors.primary.withValues(alpha: 0.08)),
          ),
          SafeArea(
  ...
  Widget _buildHeader(BuildContext context) {
    ...
    return Obx(() {
      ...
      final name = profile?.teacherName ?? 'N/A';
      final branch = profile?.branchName ?? 'N/A';
      final className =
          (profile?.assignClass != null && profile!.assignClass.isNotEmpty)
              ? profile.assignClass.first
              : 'N/A';
      final photo = (profile?.photo != null && profile!.photo!.isNotEmpty)
          ? profile.photo!
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              _StatBadge(label: 'Branch', value: branch),
                              SizedBox(width: 10.w),
                              _StatBadge(label: 'Class', value: className),
                            ],
                          ),
                        ],
                      ),
